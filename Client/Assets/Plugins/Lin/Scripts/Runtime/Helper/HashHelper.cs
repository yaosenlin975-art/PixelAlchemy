...
namespace Lin.Runtime.Helper
{
    public static class HashHelper
    {
        ...
        /// 获取字符串的MD5
        /// </summary>
        public static string StringMD5(this string str)
        {
        ...
        /// 获取字节数组的MD5
        /// </summary>
        public static string BytesMD5(this byte[] buffer)
        {
            MD5CryptoServiceProvider provider = new MD5CryptoServiceProvider();
        ...
        /// 获取字符串的Hash值
        /// </summary>
        public static string StringSHA1(this string str)
        {
            byte[] buffer = Encoding.UTF8.GetBytes(str);
        ...
        /// 获取数据流的Hash值
        /// </summary>
        public static string StreamSHA1(this Stream stream)
        {
        ...
        /// 获取字节数组的Hash值
        /// </summary>
        public static string BytesSHA1(this byte[] buffer)
        {
            // 说明：创建的是SHA1类的实例，生成的是160位的散列码
            HashAlgorithm hash = HashAlgorithm.Create();
        ...
        /// 获取字符串的CRC32
        /// </summary>
        public static string StringCRC32(this string str)
        {
            byte[] buffer = Encoding.UTF8.GetBytes(str);
        ...
        /// 获取数据流的CRC32
        /// </summary>
        public static string StreamCRC32(this Stream stream)
        {
        ...
        /// 获取字节数组的CRC32
        /// </summary>
        public static string BytesCRC32(this byte[] buffer)
        {
            CRC32Algorithm hash = new CRC32Algorithm();
            byte[] hashBytes = hash.ComputeHash(buffer);
            return ToString(hashBytes);
